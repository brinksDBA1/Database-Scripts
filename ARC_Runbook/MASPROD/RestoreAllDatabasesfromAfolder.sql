...
--Sample execution: 
-- EXEC sp_RestoreFromAllFilesInDirectory '\\DALDRSQLBAK01\SQLBackups-Dev\DALDEVSQL05$INST01\SP2010\', 'D:\MSSQL\DATA', 'D:\MSSQL\TLOGS'  
...
SET @sql = 'RESTORE DATABASE ' +'['+ @DbName+'-ECSDEV2010'+']' + ' FROM DISK = ''' + 
@dirfile + ''' WITH MOVE ' 
